...
$phpencryption_path = dirname(dirname(__DIR__)) . "/vendor/phpencryption/src/";
include $phpencryption_path . "ExceptionHandler.php";
include $phpencryption_path . "Crypto.php";
include $phpencryption_path . "Exception/CryptoException.php";
include $phpencryption_path . "Exception/InvalidCiphertextException.php";
include $phpencryption_path . "Exception/CryptoTestFailedException.php";
include $phpencryption_path . "Exception/CannotPerformOperationException.php";
